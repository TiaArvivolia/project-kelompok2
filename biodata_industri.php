                        ...
                        <div class="card-body">
                            <form action="biodata_industri_action.php?act=tambah" id="biodata" method="POST" class="form">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="responden_nama" class="form-control" required placeholder="Nama">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="Jabatan">Nama Kota</label>
                                    <input type="text" name="responden_kota" class="form-control" required placeholder="Nama Kota">
                                </div>
                                <div class="form-group">
                                    <label for="Nama Perusahaan">Nama Instansi/Perusahaan Anda</label>
                                    <input type="text" name="responden_perusahaan" class="form-control" required placeholder="nama perusahaan">
                                </div>
                                <div class="form-group">

...
<body>
    ...
    <div class="jumbotron" id="jumbotron">
        <div class="container">
            ...
            <button id="start-survey" class="btn btn-primary btn-custom">Mulai Survey</button>
        </div>
    </div>
    ...
    <script>
        // Smooth scroll for start survey button using pure JavaScript
        ...
        window.addEventListener('scroll', function () {
            ...
            if (scroll >= 300) {
                document.getElementById('jumbotron').style.backgroundImage = "url('https://images.unsplash.com/photo-1573497490083-5ee7b9b4060d')";
                document.body.style.backgroundColor = "#f2f2f2";
            } else {
                document.getElementById('jumbotron').style.backgroundImage = "url('background.png')";

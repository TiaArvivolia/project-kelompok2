                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="responden_dosen_form.php?act=tambah" class="btn btn-sm btn-primary">Tambah</a>
                        </div>
                    </div>
                    <div class="card-body">
                      ...
                      <td>
                        <a title="Edit Data" href="responden_dosen_form.php?act=edit&id=' . $row['responden_dosen_id'] . '" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>

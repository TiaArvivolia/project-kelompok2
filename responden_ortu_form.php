                    ...
                    <div class="card-body">
                        <form method="post" action="responden_ortu_action.php?act=<?= $act ?>&id=<?= $id ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="responden_tanggal" name="responden_tanggal" value="<?= isset($data['responden_tanggal']) ? date('Y-m-d\TH:i', strtotime($data['responden_tanggal'])) : '' ?>" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="responden_jk" name="responden_jk" required>
                                    <option value="L" <?= isset($data['responden_jk']) && $data['responden_jk'] == 'L' ? 'selected' : '' ?>>
                                        Laki-laki</option>
                                    <option value="P" <?= isset($data['responden_jk']) && $data['responden_jk'] == 'P' ? 'selected' : '' ?>>
                                        Perempuan</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="responden_umur">Umur</label>
                                <input type="number" class="form-control" id="responden_umur" name="responden_umur" value="<?= isset($data['responden_umur']) ? $data['responden_umur'] : '' ?>" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="responden_pendidikan" name="responden_pendidikan" value="<?= isset($data['responden_pendidikan']) ? $data['responden_pendidikan'] : '' ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="responden_pekerjaan">Pekerjaan</label>
                                <input type="text" class="form-control" id="responden_pekerjaan" name="responden_pekerjaan" value="<?= isset($data['responden_pekerjaan']) ? $data['responden_pekerjaan'] : '' ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="responden_penghasilan">Penghasilan</label>
                                <input type="text" class="form-control" id="responden_penghasilan" name="responden_penghasilan" value="<?= isset($data['responden_penghasilan']) ? $data['responden_penghasilan'] : '' ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="mahasiswa_nim">NIM Mahasiswa</label>
                                <input type="text" class="form-control" id="mahasiswa_nim" name="mahasiswa_nim" value="<?= isset($data['mahasiswa_nim']) ? $data['mahasiswa_nim'] : '' ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="mahasiswa_nama">Nama Mahasiswa</label>
                                <input type="text" class="form-control" id="mahasiswa_nama" name="mahasiswa_nama" value="<?= isset($data['mahasiswa_nama']) ? $data['mahasiswa_nama'] : '' ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="mahasiswa_prodi">Program Studi Mahasiswa</label>
                                <input type="text" class="form-control" id="mahasiswa_prodi" name="mahasiswa_prodi" value="<?= isset($data['mahasiswa_prodi']) ? $data['mahasiswa_prodi'] : '' ?>" required>
                            </div>

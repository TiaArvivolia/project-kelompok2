                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header">
                            <h2 class="card-title">Survei Kepuasan Alumni terhadap Sistem
                                Pengelolaan Sumberdaya Manusia Politeknik Negeri Malang Tahun 2024</h2>
                            <div class="card-tools"></div>
                        </div>
                        <div class="card-body">
                            <form
                                action="soal_alumni_action.php?act=simpan&responden_alumni_id=<?php echo $_GET['responden_alumni_id']; ?>"
                                method="post">
                                <div class="survey-container">
                                    <?php
                        $options = ["Sangat kurang", "Kurang", "Cukup", "Baik", "Sangat Baik"];
                        foreach ($soalAlumni->getSoalAlumni() as $soal) {

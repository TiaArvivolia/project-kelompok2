                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header">
                            <h2 class="card-title">Survei Kepuasan Mahasiswa terhadap Politeknik Negeri Malang Tahun
                                2024</h2>
                            <div class="card-tools"></div>
                        </div>
                        <div class="card-body">
                            <form action="soal_mahasiswa_action.php?act=simpan&responden_mahasiswa_id=<?php echo $_GET['responden_mahasiswa_id']; ?>" method="post">
